    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "meloyMil": myData.isVpn,
                "isMineralO": myData.uniqueNumber,
                "Ohtiert": myData.wifiAddress,
                "isNiceAppStartedNow": myData.isCharging,
            ]
